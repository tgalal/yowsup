...
MediaLocation = _reflection.GeneratedProtocolMessageType('MediaLocation', (_message.Message,), dict(
  DESCRIPTOR = _MEDIALOCATION,
  __module__ = 'encrypted_media_pb2'
  # @@protoc_insertion_point(class_scope:MediaLocation)
  ))
_sym_db.RegisterMessage(MediaLocation)

MediaContact = _reflection.GeneratedProtocolMessageType('MediaContact', (_message.Message,), dict(
  DESCRIPTOR = _MEDIACONTACT,
  __module__ = 'encrypted_media_pb2'
  # @@protoc_insertion_point(class_scope:MediaContact)
  ))
_sym_db.RegisterMessage(MediaContact)

MediaUrl = _reflection.GeneratedProtocolMessageType('MediaUrl', (_message.Message,), dict(
  DESCRIPTOR = _MEDIAURL,
  __module__ = 'encrypted_media_pb2'
  # @@protoc_insertion_point(class_scope:MediaUrl)
  ))
_sym_db.RegisterMessage(MediaUrl)

MediaDocument = _reflection.GeneratedProtocolMessageType('MediaDocument', (_message.Message,), dict(
  DESCRIPTOR = _MEDIADOCUMENT,
  __module__ = 'encrypted_media_pb2'
  # @@protoc_insertion_point(class_scope:MediaDocument)
  ))
_sym_db.RegisterMessage(MediaDocument)
