...
from .iq_groups_remove_all_participants import RemoveAllParticipantsGroupIqProtocolEntity
from .iq_result_groups_remove_all_participants import RemoveAllParticipantsResultIqProtocolEntity