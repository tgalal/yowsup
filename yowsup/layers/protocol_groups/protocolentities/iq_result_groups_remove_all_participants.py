...
class RemoveAllParticipantsResultIqProtocolEntity(ResultIqProtocolEntity):
    '''
<iq type="result" from="{{GROUP_ID}}" id="{{IQ_ID}}">
  <group subject="{{GROUPSUBJ}}" creation="{{GROUP_CREATION_TYIME}}"
    ...
    def __init__(self, _id, _from,
                 ...
                 participants):
        super(RemoveAllParticipantsResultIqProtocolEntity, self).__init__(_id = _id, _from = _from)
    ...
    def __str__(self):
        out = super(RemoveAllParticipantsResultIqProtocolEntity, self).__str__()
        out += "Group ID: %s\n" % self.groupId
    ...
    def toProtocolTreeNode(self):
        node = super(RemoveAllParticipantsResultIqProtocolEntity, self).toProtocolTreeNode()
    ...
    def fromProtocolTreeNode(node):
        ...
        return RemoveAllParticipantsResultIqProtocolEntity(
            node["id"], node["from"],
