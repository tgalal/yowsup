...
class UrlMediaMessageProtocolEntity(MediaMessageProtocolEntity):
    ...
    def __init__(self, text, match, url, description, title, _id=None, _from=None, to=None, notify=None, timestamp=None, participant=None, preview=None, offline=None, retry=None):
